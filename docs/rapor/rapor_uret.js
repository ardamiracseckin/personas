...
const govde = [
  ...
  table(
    ...
    [
      ...
      ["Birim, HTTP ve regresyon testleri", "275 test, tamamı geçiyor"],
    ],
    [4680, 4680],
  ),
  spacer(),
  ...
  p("Terminal arayüzünde cevap akarak yazıldığı için rozet metnin içine konamaz; atıflar cevabın altına cümle sırasına göre bir harita olarak yazılır (\"Atıflar: 1→[1] 3→[1] · atıfsız: 2\"). Numaralar iki arayüzde aynıdır, çünkü ikisi de getirilen parçaların sırasını kullanır."),
